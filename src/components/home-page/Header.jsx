...
export default function Header({ setPage }) {
  return (
    <>
      ...
      <video
        className="absolute -z-10 -top-8 w-full lg:hidden"
        autoPlay
        loop
        muted
        playsInline
      ...
      <div>
        ...
        <div className="flex mb-80 mt-4 lg:flex-row lg:m-0 lg:gap-8 lg:pt-12 lg:pb-40 lg:w-1/2 lg:items-center">
          <div className="text-center mt-4 lg:ml-48 lg:text-start">
            <h1 className="text-5xl mx-12 font-bold mb-2 font-karla lg:text-8xl lg:-tracking-wide">
              Nails You Will Love!
            </h1>
