...
export default function About({ setPage }) {
  return (
    <div className="flex flex-col gap-6 items-center my-40 p-8 bg-cover lg:bg-about-desktop lg:flex-row lg:p-32">
      ...
      <div className="flex flex-col gap-4 text-center items-center lg:items-start lg:p-12 lg:text-start">
        ...
        <p className="font-verdana mx-4 text-dark-gray lg:mx-0 lg:text-xl lg:ml-2">
